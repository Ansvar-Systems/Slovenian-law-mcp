/**
 * Runtime capability detection for Slovenian Law MCP server.
 *
...
export function upgradeMessage(feature: string): string {
  return (
    `The "${feature}" feature requires the Professional tier of Slovenian Law MCP. ` +
    `This instance is running the free tier. ` +
