...
This document describes the secrets and configuration required for the Slovenian Law Law MCP GitHub Actions workflows.

## Required Secrets

| Secret | Used By | Description |
|--------|---------|-------------|
| `NPM_TOKEN` | `publish.yml` | npm automation token for publishing `@ansvar/slovenian-law-mcp` |
...
3. Select **Granular Access Token** with:
   - **Packages and scopes**: Read and write, scoped to `@ansvar/slovenian-law-mcp`
