#!/usr/bin/env tsx
/**
 * Paid-tier database builder for Slovenian Law MCP server.
 *
...
function buildPaidTier(): void {
  console.log('Building paid-tier extensions for Slovenian Law MCP...\n');
  ...
  console.log(`    2. preparatory_works_full -- needs DZ full-text API (future)`);
