...
- **Professional Rules**: Odvetniška zbornica Slovenije (Slovenian Bar Association) members must comply with applicable professional conduct rules when using AI tools
...
1. Checking the official source (Uradni list Republike Slovenije (uradni-list.si), Pravno-informacijski sistem PIS (pisrs.si))
...
This Tool aggregates data from official Slovenian legal databases. However:
...
| **EUR-Lex / treaty databases** | Authoritative for EU/international law | EU obligations and transposition metadata |
...
- IUS-INFO, Tax-Fin-Lex, Pravna praksa
...
- Slovenian law changes continuously through new statutes, amendments, and court decisions
...
- **EU Law Blind Spots**: Cannot fully assess EU directive transposition or CJEU case law impact
...
2. **Official Verification**: Cross-check ALL results with official sources (Uradni list RS, PIS)
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Slovenian-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Slovenian-law-mcp/issues
