...
No query data is logged, stored, or retained by the MCP server itself. The server is stateless — each request is processed and discarded.
...
This runs entirely on your machine. No network requests are made except to your local AI client.

## Professional Use

If you are a lawyer or legal professional handling privileged or confidential client matters:
